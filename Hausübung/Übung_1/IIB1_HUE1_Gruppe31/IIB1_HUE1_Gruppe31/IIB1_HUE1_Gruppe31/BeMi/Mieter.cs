...
namespace IIB1_HUE1_Gruppe31
{
    ...
    public class Mieter
    {
        ...
        private List<Raum> mieterRaum = new List<Raum>();
        ...
        public static List<Mieter> laden(string dateipfad)
        {
            List<Mieter> DeserMieter = new List<Mieter>();
            FileStream fs = new FileStream(dateipfad, FileMode.Open);
            BinaryFormatter bf = new BinaryFormatter();
            DeserMieter = ((List<Mieter>)bf.Deserialize(fs));
            fs.Close();
            return DeserMieter;
        }

        public void speichern(string dateipfad, List<Mieter> m)
        {
        ...
        public List<Raum> MieterRaum { get => mieterRaum; set => mieterRaum = value; }
    }
}
